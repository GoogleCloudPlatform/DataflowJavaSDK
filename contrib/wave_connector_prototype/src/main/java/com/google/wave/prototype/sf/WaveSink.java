...
/**
 * A custom sink that writes to Salesforce Wave {@link  http://www.salesforce.com/analytics-cloud/overview/}.  
 * Here's a description of the Wave API {@link https://resources.docs.salesforce.com/sfdc/pdf/bi_dev_guide_ext_data.pdf}
 *	
 *		Usage:
...
public class WaveSink extends Sink<String> {
	...
	public static class WaveWriteOperation extends Sink.WriteOperation<String, WaveWriteResult> {
		...
		public void finalize(Iterable<WaveWriteResult> writerResults,
			...
			//not setting file header since field names can vary based on use case
		...
		private String publishMetaData(PartnerConnection connection) throws Exception {
			...
			// TODO : Currently reading the metadata file from GCS
