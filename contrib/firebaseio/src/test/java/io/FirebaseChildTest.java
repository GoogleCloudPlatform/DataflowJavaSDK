...
public abstract class FirebaseChildTest extends BaseFirebaseSourceTest {
  ...
  /* (non-Javadoc)
   * @see io.BaseFirebaseSourceTest#addListener(com.firebase.client.Firebase, java.util.Collection)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see io.BaseFirebaseSourceTest#removeListener(com.firebase.client.Firebase)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see io.BaseFirebaseSourceTest#makePipeline()
   */
  @Override
