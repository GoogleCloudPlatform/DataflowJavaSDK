...
public abstract class BaseFirebaseSourceTest {
  ...
  final Logger logger = LoggerFactory.getLogger(BaseFirebaseSourceTest.class);
  ...
  public void matchEvents() throws Throwable{
    ...
    PCollection<FirebaseEvent<JsonNode>> events = p
        ...
        .apply(ParDo.of(new LoggingDoFn<FirebaseEvent<JsonNode>>(FirebaseChildTest.class)));
